...
class _$_RegisterState implements _RegisterState {
  ...
  @override
  String toString() {
    return 'RegisterState(status: $status, firstName: $firstName, password: $password, email: $email, login: $login, languageId: $languageId, register: $register, authFailure: $authFailure)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, status, firstName, password,
      email, login, languageId, register, authFailure);
